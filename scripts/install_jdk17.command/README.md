...
* 本文是 `install_jdk17.command` 的脚本自述文件。

* 检测并安装 JDK 17，优先使用 Homebrew Cask，兜底使用 openjdk@17。
...
`install_jdk17.command` 采用独立目录管理，便于阅读、维护、迁移和长期扩展。
